...
def count_down(count):
    ...
    if count > 0:
        ...
        start_timer()
        check_mark = "✓"
        checkmark_label.config(text=check_mark*math.floor(reps/2))

# ---------------------------- UI SETUP ------------------------------- #


window = Tk()
window.title("Pomodoro Work Assistant")
...
# Checkmark Label
checkmark_label = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 50, "normal"))
